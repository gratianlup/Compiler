...
OrderType Peephole::CombineOrdersAnd(OrderType a, OrderType b, bool& orderFalse) {
	...
	case OrderType::Equal: {
		switch(b) {
			case OrderType::Equal: return OrderType::Equal;          // (a == 5) & (a == 5)
			case OrderType::LessOrEqual: return OrderType::Equal;    // (a == 5) & (a <= 5)
			case OrderType::GreaterOrEqual: return OrderType::Equal; // (a == 5) & (a >= 5)
	...
	case OrderType::NotEqual: {
		switch(b) {
			case OrderType::NotEqual: return OrderType::NotEqual;      // (a != 5) & (a != 5)
			case OrderType::Less: return OrderType::Less;		         // (a != 5) & (a < 5)
			case OrderType::Greater: return OrderType::Greater;		 // (a != 5) & (a > 5)
			case OrderType::LessOrEqual: return OrderType::Less;		 // (a != 5) & (a <= 5)
			case OrderType::GreaterOrEqual: return OrderType::Greater; // (a != 5) & (a >= 5)
			default: orderFalse = true; break;
		}
		break;
	}
	case OrderType::Less: {
		switch(b) {
			case OrderType::Less: return OrderType::Less;        // (a < 5) & (a < 5)
			case OrderType::LessOrEqual: return OrderType::Less; // (a < 5) & (a <= 5)
			case OrderType::NotEqual: return OrderType::Less;    // (a < 5) & (a != 5)
			default: orderFalse = true; break;
		}
		break;
	}
	case OrderType::LessOrEqual: {
		switch(b) {
			case OrderType::LessOrEqual: return OrderType::LessOrEqual; // (a <= 5) & (a <= 5)
			case OrderType::Equal: return OrderType::Equal;             // (a <= 5) & (a == 5)
			case OrderType::NotEqual: return OrderType::Less;           // (a <= 5) & (a != 5)
			case OrderType::Less: return OrderType::Less;               // (a <= 5) & (a < 5)
			case OrderType::GreaterOrEqual: return OrderType::Equal;    // (a <= 5) & (a >= 5)
	...
	case OrderType::Greater: {
		switch(b) {
			case OrderType::Greater: return OrderType::Greater;        // (a > 5) & (a > 5)
			case OrderType::GreaterOrEqual: return OrderType::Greater; // (a > 5) & (a >= 5)
			case OrderType::NotEqual: return OrderType::Greater;       // (a > 5) & (a != 5)
			default: orderFalse = true; break;
		}
		break;
	}
	case OrderType::GreaterOrEqual: {
		switch(b) {
			case OrderType::GreaterOrEqual: return OrderType::GreaterOrEqual;
			case OrderType::Greater: return OrderType::Greater;   // (a >= 5) & (a > 5)
			case OrderType::Equal: return OrderType::Equal;       // (a >= 5) & (a == 5)
			case OrderType::NotEqual: return OrderType::Greater;  // (a >= 5) & (a > 5)
			case OrderType::LessOrEqual: return OrderType::Equal; // (a >= 5) & (a <= 5)
...
OrderType Peephole::CombineOrdersOr(OrderType a, OrderType b, bool& orderTrue) {
	...
	case OrderType::Equal: {
		switch(b) {
			case OrderType::Equal: return OrderType::Equal;                   // (a == 5) | (a == 5)
			case OrderType::LessOrEqual: return OrderType::LessOrEqual;       // (a == 5) | (a <= 5)
			case OrderType::GreaterOrEqual: return OrderType::GreaterOrEqual; // (a == 5) | (a >= 5)
			case OrderType::Greater: return OrderType::Greater;               // (a == 5) | (a > 5)
			case OrderType::Less: return OrderType::LessOrEqual;              // (a == 5) | (a < 5)
	...
	case OrderType::NotEqual: {
		switch(b) {
			case OrderType::NotEqual: return OrderType::NotEqual; // (a != 5) | (a != 5)
			case OrderType::Less: return OrderType::NotEqual;		// (a != 5) | (a < 5)
			case OrderType::Greater: return OrderType::NotEqual;	// (a != 5) | (a > 5)
			default: orderTrue = true; break;
		}
		break;
	}
	case OrderType::Less: {
		switch(b) {
			...
			case OrderType::NotEqual: return OrderType::NotEqual;       // (a < 5) | (a != 5)
			case OrderType::Greater: return OrderType::NotEqual;        // (a < 5) | (a > 5)
			case OrderType::Equal: return OrderType::LessOrEqual;       // (a < 5) | (a == 5)
			default: orderTrue = true; break;
		}
		break;
	}
	...
	case OrderType::Greater: {
		switch(b) {
			...
			case OrderType::GreaterOrEqual: return OrderType::GreaterOrEqual; // (a > 5) | (a >= 5)
			case OrderType::NotEqual: return OrderType::NotEqual;             // (a > 5) | (a != 5)
			case OrderType::Equal: return OrderType::GreaterOrEqual;          // (a > 5) | (a == 5)
			case OrderType::Less: return OrderType::NotEqual;                 // (a > 5) | (a < 5)
			default: orderTrue = true; break;
		}
		break;
	...
	case OrderType::GreaterOrEqual: {
		switch(b) {
			case OrderType::GreaterOrEqual: return OrderType::GreaterOrEqual; // (a >= 5) | (a >= 5)
			case OrderType::Greater: return OrderType::GreaterOrEqual;        // (a >= 5) | (a > 5)
			case OrderType::Equal: return OrderType::GreaterOrEqual;          // (a >= 5) | (a == 5)
			default: orderTrue = true; break;
		}
		break;
...
OrderType Peephole::CombineOrdersXor(OrderType a, OrderType b, bool& orderFalse,
	...
	case OrderType::Equal: {
		switch(b) {
			...
			case OrderType::Greater: return OrderType::GreaterOrEqual; // (a == 5) ^ (a > 5)
			case OrderType::Less: return OrderType::LessOrEqual;       // (a == 5) ^ (a < 5)
			case OrderType::Equal: orderFalse = true; break;
			case OrderType::NotEqual: orderTrue = true; break;
		}
		break;
	}
	case OrderType::NotEqual: {
		switch(b) {
			case OrderType::Greater: return OrderType::Less;		         // (a != 5) ^ (a < 5)
			case OrderType::GreaterOrEqual: return OrderType::LessOrEqual; // (a != 5) ^ (a <= 5)
			case OrderType::Less: return OrderType::Greater;		         // (a != 5) ^ (a > 5)
			case OrderType::LessOrEqual: return OrderType::GreaterOrEqual; // (a != 5) ^ (a >= 5)
			case OrderType::Equal: orderTrue = true; break;
			case OrderType::NotEqual: orderFalse = true; break;
		}
		break;
	}
	case OrderType::Less: {
		switch(b) {
			...
			case OrderType::NotEqual: return OrderType::Greater;	// (a < 5) ^ (a != 5)
			case OrderType::LessOrEqual: return OrderType::Equal; // (a < 5) ^ (a <= 5)
			case OrderType::Less: orderFalse = true; break;
			case OrderType::GreaterOrEqual: orderTrue = true; break;
		}
		break;
	}
	case OrderType::LessOrEqual: {
		switch(b) {
			case OrderType::Equal: return OrderType::Less;              // (a <= 5) ^ (a == 5)
			case OrderType::GreaterOrEqual: return OrderType::NotEqual; // (a <= 5) ^ (a >= 5)
			case OrderType::Less: return OrderType::Equal;		      // (a <= 5) ^ (a < 5)
			case OrderType::NotEqual: return OrderType::GreaterOrEqual; // (a <= 5) ^ (a != 5)
			case OrderType::LessOrEqual: orderFalse = true; break;
			case OrderType::Greater: orderTrue = true; break;
		}
		break;
	}
	case OrderType::Greater: {
		switch(b) {
			...
			case OrderType::Less: return OrderType::NotEqual;          // (a > 5) ^ (a < 5)
			case OrderType::NotEqual: return OrderType::Less;          // (a > 5) ^ (a != 5)
			case OrderType::LessOrEqual: orderTrue = true; break;
			case OrderType::Greater: orderFalse = true; break;
		}
		break;
	}
	case OrderType::GreaterOrEqual: {
		switch(b) {
			case OrderType::Greater: return OrderType::Equal;        // (a > 5) ^ (a >= 5)
			case OrderType::Equal: return OrderType::Greater;        // (a > 5) ^ (a == 5)
			case OrderType::NotEqual: return OrderType::LessOrEqual; // (a > 5) ^ (a != 5)
			case OrderType::LessOrEqual: return OrderType::NotEqual; // (a > 5) ^ (a <= 5)
			case OrderType::GreaterOrEqual: orderFalse = true; break;
			case OrderType::Less: orderTrue = true; break;
		}
		break;
	}
	}
...
Operand* Peephole::HandleXor(Operand* opA, Operand* opB, Block* block,
	...
	if(auto result = folder_.FoldBinary(Opcode::Xor, opA, opB, block)) {
		return LOG(result);
	}
    ...
    if(auto result = HandleAssociative(Opcode::Xor, opA, opB, block)) {
        return result;
    }

    // Try to simplify using distributivity rules.
    if(auto result = HandleDistributive(Opcode::Xor, opA, opB, block)) {
        return result;
    }
    ...
    if(auto result = HandleInstructionOnPhi(Opcode::Xor, opA, opB)) {
        return result;
    }

	// Check if we are adding at least one 'quest' instruction result.
    if(auto result = HandleOperationOnQuest(Opcode::Xor, opA, opB)) {
        return result;
    }
...
Operand* Peephole::HandleXorIntCmp(Operand* opA, Operand* opB, Block* block) {
	...
	if(IsOneInt(opB, block) && opA->HasDefiningInstruction()) {
		...
		if(auto sextInstr = opA->DefiningInstrAs<SextInstr>()) {
			...
			if(targetInstr->IsComparison()) {
				cmpInstr = static_cast<CmpInstrBase*>(targetInstr);
			}
		}
...
Operand* Peephole::HandleShl(ShlInstr* instr) {
	...
	if(auto result = folder_.FoldBinary(Opcode::Shl, instr->LeftOp(), 
                                        instr->RightOp(), 
                                        instr->ParentBlock())) {
		return LOG(result);
	}
	...
	// Check if we are adding at least one 'quest' instruction result.
    return HandleOperationOnQuest(Opcode::Shl, instr->LeftOp(), 
                                  instr->RightOp());
}
...
Operand* Peephole::HandleShr(ShrInstr* instr) {
	// We use the constant evaluator even if not both operands are constant,
	// because it also eliminates very simple cases.
	if(auto result = folder_.FoldBinary(Opcode::Shr, instr->LeftOp(), 
                                        instr->RightOp(), 
                                        instr->ParentBlock())) {
		return LOG(result);
	}
	...
	// Check if we are adding at least one 'quest' instruction result.
    return HandleOperationOnQuest(Opcode::Shr, instr->LeftOp(), 
                                  instr->RightOp());
}
...
Operand* Peephole::HandleUshr(UshrInstr* instr) {
	// We use the constant evaluator even if not both operands are constant,
	// because it also eliminates very simple cases.
	if(auto result = folder_.FoldBinary(Opcode::Ushr, instr->LeftOp(), 
                                        instr->RightOp(), 
                                        instr->ParentBlock())) {
		return LOG(result);
	}
	...
	// Check if we are adding at least one 'quest' instruction result.
    return HandleOperationOnQuest(Opcode::Ushr, instr->LeftOp(), 
                                  instr->RightOp());
}
...
Operand* Peephole::HandleShiftCommon(LogicalInstr* instr) {
    ...
    if(auto result = HandleShiftConst(opA, opB, instr)) {
        return result;
    }
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Operand* Peephole::HandleShiftConst(Operand* opA, Operand* opB, LogicalInstr* instr) {
	Operand* a;
	IntConstant* C1;
	IntConstant* C2;
	auto type = instr->ResultOp()->GetType()->As<IntegerType>();
	...
	if(IA::AreEqual(C1, C2)) {
		...
		if((leftInstr->IsShr() || 
			...
			// (-1 << C2)
			__int64 result = IA::Shl(-1, C2->Value(), intKind);
		...
		if(leftInstr->IsShl() && instr->IsUshr()) {
			...
			// (-1 >> C2)
			__int64 result = IA::Ushr(-1, C2->Value(), intKind);
			auto constOp2 = irGen_.GetIntConst(type, result);
	...
	switch(definingInstr->GetOpcode()) {
		case Opcode::Shl: {
			...
			if(isLeft) {
				...
				int maskBits = (int)IA::Sub(bitwidth, shiftAmount->Value(), intKind);
		...
		case Opcode::Ushr: {
			...
			if(isLeft) {
				...
				auto intKind = intConst->GetType()->GetSubtype();
				int maskBits = (int)IA::Sub(-1, shiftAmount->Value(), intKind);
