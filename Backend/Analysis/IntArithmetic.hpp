...
public:
	...
	static __int64 GetMinusOneMask(IRIntegerKind kind) {
		switch(kind) {
			case IRIntegerKind::Int8:  return (__int64)0xFF;
			case IRIntegerKind::Int16: return (__int64)0xFFFF;
			case IRIntegerKind::Int32: return (__int64)0xFFFFFFFF;
			case IRIntegerKind::Int64: return (__int64)0xFFFFFFFFFFFFFFFF;
		}
	...
	static __int64 LimitToType(__int64 value, IRIntegerKind kind, 
        ...
        if(isSigned) {
		    switch(kind) {
			    case IRIntegerKind::Int8:  { value = (value << (64 -  8)) >> (64 - 8);  break; }
			    case IRIntegerKind::Int16: { value = (value << (64 - 16)) >> (64 - 16); break; }
			    case IRIntegerKind::Int32: { value = (value << (64 - 32)) >> (64 - 32); break; }
		    }
        }
        else {
	...
	static __int64 LimitToType(const IntConstant* value, const IntegerType* type,
                               bool isSigned = true) {
    ...
    static __int64 LimitToType(const IntConstant* value, bool isSigned = true) {
	...
	static int TypeBits(IRIntegerKind kind) {
		switch(kind) {
			case IRIntegerKind::Int8:  return 8;
			case IRIntegerKind::Int16: return 16;
			case IRIntegerKind::Int32: return 32;
			case IRIntegerKind::Int64: return 64;
		}
    ...
    static int TypeBits(const IntConstant* value) {
        return TypeBits(value->GetType());
    }
	...
	static int OneBits(const IntConstant* value) {
	...
	static int ZeroBits(const IntConstant* value) {
	...
	static int RightmostZeroBits(const IntConstant* value) {
    ...
    static int RightmostOneBits(const IntConstant* value) {
	...
	static int LeftmostZeroBits(const IntConstant* value) {
    ...
    static int LeftmostOneBits(const IntConstant* value) {
	...
	static int LeftmostSetBit(const IntConstant* value) {
	...
	static bool IsPowerOfTwo(unsigned __int64 value) {
        return (value & (value - 1)) == 0;
    }
	...
	static __int64 NextPowerOfTwo(const IntConstant* value) {
		// Taken from "Hacker's Delight".
	...
	static int Log2(__int64 value, IRIntegerKind kind) {
		value = LimitToType(value, kind, false /* no sign extension */);

		// log2 is equal to the index of the rightmost set bit.
        if(value > 0) {
			return RightmostSetBit(value, kind);
		}
        else return 0;
	}

    static int Log2(__int64 value) {
        if(value > 0) {
			return RightmostZeroBits(value, IRIntegerKind::Int64);
		}
        else return 0;
	}

	static int Log2(const IntConstant* value) {
	...
	static __int64 GetSignBitMask(IRIntegerKind kind) {
		switch(kind) {
			case IRIntegerKind::Int8:  return 0x80LL;
			case IRIntegerKind::Int16: return 0x8000LL;
			case IRIntegerKind::Int32: return 0x80000000LL;
			case IRIntegerKind::Int64: return 0x8000000000000000LL;
		}
	...
	static int GetSignBit(const IntConstant* value) {
	...
	static __int64 ValueFromBitCount(unsigned int bits) {
		return (bits == 64) ? 0xFFFFFFFFFFFFFFFF : (1LL << bits) - 1;
	}

	static __int64 ValueFromBitCount(__int64 bits) {
		return (bits == 64) ? 0xFFFFFFFFFFFFFFFF : (1LL << bits) - 1;
	}

	static __int64 ValueFromBitCount(unsigned __int64 bits) {
		return (bits == 64) ? 0xFFFFFFFFFFFFFFFF : (1LL << bits) - 1;
	}

	static __int64 ValueFromBitCount(IntConstant* value) {
		return ValueFromBitCount(value->Value());
	}

	static bool IsPositive(const IntConstant* value) {
		return value->Value() >= 0;
	}

	static bool IsNegative(const IntConstant* value) {
		return value->Value() < 0;
	}
	...
	static __int64 Add(const IntConstant* a, const IntConstant* b) {
	...
	static __int64 Sub(const IntConstant* a, const IntConstant* b) {
	...
	static __int64 Mul(const IntConstant* a, const IntConstant* b) {
	...
	static __int64 Div(const IntConstant* a, const IntConstant* b) {
	...
	static __int64 Udiv(const IntConstant* a, const IntConstant* b) {
	...
	static __int64 Mod(const IntConstant* a, const IntConstant* b) {
	...
	static __int64 Umod(const IntConstant* a, const IntConstant* b) {
	...
	static __int64 And(const IntConstant* a, const IntConstant* b) {
	...
	static __int64 Or(const IntConstant* a, const IntConstant* b) {
	...
	static __int64 Xor(const IntConstant* a, const IntConstant* b) {
	...
	static __int64 Not(const IntConstant* value) {
	...
	static __int64 Shl(const IntConstant* a, const IntConstant* b) {
	...
	static __int64 Ushr(const IntConstant* a, const IntConstant* b) {
	...
	static __int64 Sext(const IntConstant* value, const IntegerType* toKind) {
	...
	static __int64 Zext(const IntConstant* value, const IntegerType* toKind) {
	...
	static __int64 Trunc(const IntConstant* value, const IntegerType* toKind) {
	...
	static double Itof(__int64 value, IRIntegerKind fromKind, IRFloatingKind toKind) {
		value = LimitToType(value, fromKind);
		if(toKind == IRFloatingKind::Double) return (double)value;
		else return (float)value;
	}

	static double Itof(const IntConstant* value, const FloatingType* toKind) {
	...
	static double Uitof(__int64 value, IRIntegerKind fromKind, IRFloatingKind toKind) {
		...
		if(toKind == IRFloatingKind::Float) return (float)result;
		else return result;
	}

	static double Uitof(const IntConstant* value, const FloatingType* toKind) {
	...
	static bool AreEqual(const IntConstant* a, const IntConstant* b) {
	...
	static bool AreNotEqual(const IntConstant* a, const IntConstant* b) {
	...
	static bool IsSmaller(const IntConstant* a, const IntConstant* b) {
	...
	static bool IsSmallerUnsigned(const IntConstant* a, const IntConstant* b) {
	...
	static bool IsSmallerOrEqual(const IntConstant* a, const IntConstant* b) {
	...
	static bool IsSmallerOrEqualUnsigned(const IntConstant* a, const IntConstant* b) {
	...
	static bool IsLarger(const IntConstant* a, const IntConstant* b) {
	...
	static bool IsLargerUnsigned(const IntConstant* a, const IntConstant* b) {
	...
	static bool IsLargerOrEqual(const IntConstant* a, const IntConstant* b) {
	...
	static bool IsBitSet(int bit, const IntConstant* value) {
	...
	static bool IsMultipleOf(const IntConstant* a, const IntConstant* b) {
	...
	static bool AddOverflows(const IntConstant* a, const IntConstant* b) {
	...
	static bool SubOverflows(const IntConstant* a, const IntConstant* b) {
	...
	static bool MulOverflows(const IntConstant* a, const IntConstant* b) {
	...
	static bool DivOverflows(const IntConstant* a, const IntConstant* b) {
	...
	static bool UdivOverflows(const IntConstant* a, const IntConstant* b) {
