...
void IndirectCallPromotion::UpdateCallGraph(CallList& createdCalls, 
    ...
    callNode->RemoveCallSite(originalCallSite);
    callGraph_->RemoveCallSite(originalCallSite);
}
...
UcmpInstr* IndirectCallPromotion::CreateTargetComparison(Operand* targetOp, 
    ...
    return UcmpInstr::GetUcmp(OrderType::Equal, targetOp, functionRef, resultOp);
}
