...
protected:
    ...
    static const __int64 UNKNOWN_TARGET     = -4;
    ...
    struct UnknownTarget {
        ...
        bool IsUnknownTarget() const {
            return TargetIndex == UNKNOWN_TARGET;
        }
    ...
    Dictionary<UnknownTarget, bool> unknownTargets_;
    ...
    void AddUnknownToParameter(FunctionReference* callTarget,
                               __int64 argumentIndex);

    void AddUnknownToParameters(UnknownTargetList& callTargetList,
                                __int64 argumentIndex);
    ...
    void MarkTargetUnknown(UnknownTarget target) {
        unknownTargets_.Add(target, true);
    }
