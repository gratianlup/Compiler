...
public:
    ...
    bool HasNoAlias(Operand* opA, Operand* opB) {
        return ComputeAlias(opA, opB) == AliasResult::None;
    }
    ...
    bool HasMustAlias(Operand* opA, Operand* opB) {
        return ComputeAlias(opA, opB) == AliasResult::Must;
    }

    bool HasMayAlias(Operand* opA, Operand* opB) {
        return ComputeAlias(opA, opB) == AliasResult::May;
    }

    bool HasNoAliasWithUnknownSize(Operand* opA, Operand* opB) {
        return ComputeAliasWithUnknownSize(opA, opB) == AliasResult::None;
    }

    bool HasAliasWithUnknownSize(Operand* opA, Operand* opB) {
        return ComputeAliasWithUnknownSize(opA, opB) != AliasResult::None;
    }

    bool HasMustAliasWithUnknownSize(Operand* opA, Operand* opB) {
        return ComputeAliasWithUnknownSize(opA, opB) == AliasResult::Must;
    }

    bool HasMayAliasWithUnknownSize(Operand* opA, Operand* opB) {
        return ComputeAliasWithUnknownSize(opA, opB) == AliasResult::May;
    }
